          ...
          <div className="p-5">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-semibold text-white">Driver Linking Code</h3>
                  <p className="text-xs text-slate-400">Share this code with your drivers</p>
                </div>
              </div>
              {linkedDriverCount > 0 && (
            ...
            <div className="bg-slate-700/50 rounded-lg p-4 mb-3">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <p className="text-xs text-slate-400 mb-1 font-medium tracking-wide uppercase">Company Code</p>
            ...
            <div className="flex items-start gap-2 mb-3">
              <div className="w-1 h-1 rounded-full bg-slate-500 mt-2 flex-shrink-0" />
              <p className="text-xs text-slate-400 leading-relaxed">
                Drivers enter this code during their courier sign-up to automatically join your fleet.
              </p>
            </div>
