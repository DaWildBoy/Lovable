...
import { TrendingUp, TrendingDown, Minus, DollarSign, Package, BarChart3 } from 'lucide-react';
...
export function SpendingSummary({ userId }: Props) {
  ...
  if (data.thisMonth === 0 && data.lastMonth === 0) return null;
