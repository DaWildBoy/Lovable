...
import { Bell, Check, Package, DollarSign, Truck, MapPin, AlertCircle, Loader2, X, UserPlus } from 'lucide-react';
import { Database } from '../../lib/database.types';

type Notification = Database['public']['Tables']['notifications']['Row'];

interface CourierNotificationsProps {
  onNavigate?: (path: string) => void;
}

export function CourierNotifications({ onNavigate }: CourierNotificationsProps = {}) {
  const { user } = useAuth();
