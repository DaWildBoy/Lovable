...
import { Bell, Check, Package, DollarSign, Truck, MapPin, AlertCircle, Loader2, X, Navigation2, UserPlus, RotateCcw } from 'lucide-react';
...
export function BusinessNotifications({ onNavigate }: BusinessNotificationsProps = {}) {
  const { user } = useAuth();
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    if (notification.type === 'driver_link_request') {
      if (onNavigate) {
